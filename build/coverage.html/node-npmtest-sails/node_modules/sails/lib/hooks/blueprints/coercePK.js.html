...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sails/node_modules/sails/lib/hooks/blueprints/coercePK.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sails/node_modules/sails/lib/hooks/blueprints/coercePK.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sails/node_modules/sails/lib/hooks/blueprints/</a> &#187; coercePK.js</div>
</div>
<div class="body">
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >function validId (id, controllerId, actionId) {</span></span>
&nbsp;
        // Interlace app-global `config.controllers` with this controller's `_config`
<span class="cstat-no" title="statement not covered" >        var controllerConfig = _.merge({}, </span>
...
<span class="cstat-no" title="statement not covered" >        if (    controllerConfig.blueprints.shortcuts &amp;&amp; (</span>
                id === 'find'   ||
                id === 'update' ||
                id === 'create' ||
                id === 'destroy' )) {
...
<span class="cstat-no" title="statement not covered" >        if ( !controllerConfig.blueprints.expectIntegerId ) {</span>
<span class="cstat-no" title="statement not covered" >            return id;</span>
        }
&nbsp;
        // Ensure that id is numeric (unless this check is disabled)
<span class="cstat-no" title="statement not covered" >        var castId = +id;</span>
<span class="cstat-no" title="statement not covered" >        if (id &amp;&amp; _.isNaN(castId)) {</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            if (sails.config.environment === 'development') {</span>
<span class="cstat-no" title="statement not covered" >                sails.log.warn('\n',</span>
...
&nbsp;
        // Id is an integer
<span class="cstat-no" title="statement not covered" >        return parseInt(id, 10);</span>
    };
};
&nbsp;
&nbsp;
