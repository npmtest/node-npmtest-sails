...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sails/node_modules/sails/lib/hooks/views/escape-html-entities-deep.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sails/node_modules/sails/lib/hooks/views/escape-html-entities-deep.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sails/node_modules/sails/lib/hooks/views/</a> &#187; escape-html-entities-deep.js</div>
</div>
<div class="body">
 ...
 */
module.exports = <span class="fstat-no" title="function not covered" >function escapeHtmlEntitiesDeep(data){</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return rttc.rebuild(data, <span class="fstat-no" title="function not covered" >function escape(val, type){</span></span>
...
<span class="cstat-no" title="statement not covered" >      return _.escape(val);</span>
    }
    else {
