...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sails/node_modules/sails/lib/hooks/request/locals.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sails/node_modules/sails/lib/hooks/request/locals.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sails/node_modules/sails/lib/hooks/request/</a> &#187; locals.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
<span class="cstat-no" title="statement not covered" >module.exports = <span class="fstat-no" title="function not covered" >function _mixinLocals(req, res) {</span></span>
&nbsp;
    // TODO:
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _.extend(res.locals, {</span>
        _: _,
        util: util,
        session: req.session,
        req: req,
...
<span class="cstat-no" title="statement not covered" >    res.locals.title = req._sails.config.appName;</span>
<span class="cstat-no" title="statement not covered" >    if (req.options.action) {</span>
<span class="cstat-no" title="statement not covered" >        ' | ' + util.str.capitalize(req.param('action'));</span>
    }
};
&nbsp;
&nbsp;</pre></td></tr>
